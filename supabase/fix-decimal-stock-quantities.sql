...
-- drop dependent views that reference stock_quantity so we can change the column type
drop view if exists public.expiry_alerts cascade;
...
-- recreate views that were dropped earlier
