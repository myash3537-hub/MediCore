...
export function Sidebar({ profile }: Readonly<{ profile: Profile }>) {
  ...
  return (
    <aside className="glass-panel border-r border-white/60 p-4 lg:sticky lg:top-0 lg:h-screen lg:overflow-hidden lg:p-6">
      <div className="relative flex h-full flex-col overflow-hidden rounded-[32px] border border-white/10 bg-slate-975 p-5 text-white shadow-[0_30px_70px_rgba(8,18,31,0.28)]">
        ...
        <div className="relative mt-8 min-h-0 flex-1 overflow-hidden">
          <div className="scrollbar-thin flex max-h-full flex-col gap-2 overflow-y-auto pr-2">
